      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={handleFlip} style={styles.btn} activeOpacity={0.7} disabled={isPlayingNoise}>
          <Icon name="refresh-cw" size={20}
            color={isPlayingNoise ? colors.light.border : colors.light.iconColor} />
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  noiseText: { color: colors.light.accent, fontSize: 12, fontFamily: "Inter_600SemiBold", letterSpacing: 3 },
  dot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.light.accent, opacity: 0.7 },
  ...
  flipText: { color: colors.light.iconColor, fontSize: 11, fontFamily: "Inter_700Bold", letterSpacing: 2 },
});
